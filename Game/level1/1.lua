...
physics.addBody(rbar[2], "static", {bounce = 0, shape= rect3Shape, friction = 0.3})
physics.addBody(rbar[3], "static", {bounce = 0, shape= rect4Shape, friction = 0.3})
physics.addBody(rbar[4], "static", {bounce = 0, shape= rect5Shape, friction = 0.3})
physics.addBody(rbar[5], "static", {bounce = 0, shape= rect6Shape, friction = 0.3})
physics.addBody(rbar[6], "static", {bounce = 0, shape= rect7Shape, friction = 0.3})
...
physics.addBody(bbar[3], "static", {bounce = 0, shape= rect9Shape, friction = 0.3})
physics.addBody(bbar[4], "static", {bounce = 0, shape= rect9Shape, friction = 0.3})
